...
from ..models.PatientMasterModel import PatientMasterModel
...
class Auth():
  ...
  def decode_token(token):
    ...
    try:
      ...
      re['data'] = {'user_id': payload['user_id'],'user_type':payload['user_type']}
      return re
  ...
  def auth_required(func):
      ...
      def decorated_auth(*args, **kwargs):
          ...
          user = None
          if user_type == 'PA':
               user = PatientMasterModel.get_patient_by_id(user_id)
          if user_type == 'DR':
               user = None
          if user_type == 'CFR':
               user = None
